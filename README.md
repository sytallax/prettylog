...
This package was created from this article by [dusted.codes](https://dusted.codes/creating-a-pretty-console-logger-using-gos-slog-package) with improvements from this repository by [dusted-go](https://github.com/dusted-go/logging).
